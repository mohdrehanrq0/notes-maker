      ...
      >
        ...
        {selectedData.response.map((e: any, i: number) => (
          <React.Fragment key={i}>
            ...
            <div className="text-black font-nunito my-2">
              <span className="text-black font-bold font-nunito text-base ">
                Example: &nbsp;
              </span>
              {e.example}
            </div>
            {e?.extraPoints?.length > 0 && (
            ...
            {e.youtubeIds && (
              <div className="mb-8  text-black">
                <div className="font-semibold mb-3">Youtube links</div>
